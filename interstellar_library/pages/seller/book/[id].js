...
// #endregion
  ...
  const fetchBookData = async () => {
    try {
      const response = await axios.get('http://localhost:3000/seller/books/search_books/' + router.query.id);
    ...
    const handleSubmit = async (e) => {
        ...
        try {
          ...
          const response = await axios.put("http://localhost:3000/seller/books/update_book_info/"+CollectedBookData?.Book_ID, formData);
    ...
    const fetchBookImage = async () => {
      try {
        const response = await axios.get(`http://localhost:3000/seller/book/book_image/`+router.query.id, {
        ...
        <div className="flex items-center justify-center h-screen">
          <form onSubmit={handleSubmit} encType="multipart/form-data">
            ...
            <input
              type="hidden"
              id="Book_ID"
              value={CollectedBookData?.Book_ID || 0}
